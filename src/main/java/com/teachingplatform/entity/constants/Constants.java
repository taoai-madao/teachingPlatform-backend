package com.teachingplatform.entity.constants;
...
public class Constants {
    ...
    public static final String REDIS_KEY_DOWNLOAD = "teachingplatform:download:";

    public static final String REDIS_KEY_SYS_SETTING = "teachingplatform:syssetting:";

    public static final String REDIS_KEY_USER_SPACE_USE = "teachingplatform:user:spaceuse:";

    public static final String REDIS_KEY_USER_FILE_TEMP_SIZE = "teachingplatform:user:file:temp:";
